const recipes = [
  ...
  },
  {
    ...
    ingredients: '1 slice whole wheat bread \n 1 avocado \n 2 tsp cream cheese \n salt and pepper to taste \n red pepper flakes to taste \n 1 lemon slice 1 egg (optional)',
    directions: '1. Toast slice of bread. While waiting, slice avocado in half vertically and remove pit. Once toast is finished, spread cream cheese and score avocado halves vertically. Spread avocado on top of cream cheese and season with salt, pepper, and red pepper flakes to taste. Serve with lemon slice.',
    cookTime: 5,
    servings: 1
  }
];
